...
For anything that sends mail or mutates subscribers in Kit, the test plan **must** state how it was verified safely (dry-run, test segment) and confirm no live audience was emailed.
